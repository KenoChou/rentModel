  ...
  return h('main', { className: 'shell' },
    ...
    h('section', { className: 'content' },
      ...
      h('section', { className: 'metric-grid', 'aria-label': '精选内容' },
        h('article', { className: 'metric-card' }, h('span', null, '热门模型'), h('strong', null, '36'), h('p', null, '覆盖找房、合同、知识问答')),
        h('article', { className: 'metric-card' }, h('span', null, '推荐工具'), h('strong', null, '18'), h('p', null, '可一键连接 MCP 客户端')),
        h('article', { className: 'metric-card' }, h('span', null, '精选应用'), h('strong', null, '24'), h('p', null, '开箱即用的 AI Spaces')),
        h('article', { className: 'metric-card' }, h('span', null, '最近发布'), h('strong', null, '7'), h('p', null, '本周新增体验内容')),
      ),
